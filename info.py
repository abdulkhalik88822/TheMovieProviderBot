...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002175017994').split()] #Channel id for auto indexing ( make sure bot is admin )
...
HOWTOVERIFY = environ.get('HOWTOVERIFY', url='https://t.me/moviedeta') # How to open tutorial link for verification
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/moviedeta') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : ʜᴘ')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001626107740')) #Log channel id ( make sure bot is admin )
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/movieserch23089') #Support group link ( make sure bot is admin )
